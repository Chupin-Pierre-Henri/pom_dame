...
public class FinPanel extends JPanel {
    ...
    public void paintComponent(Graphics g) {
        ...
        if (joueur == 0) {
            g.drawString("Il y a EGALITE avec un score de :", 80, 75);
        } else if (joueur == -1) {
            g.drawString("Vous avez PERDU avec un score de :", 60, 75);
        } else {
            g.drawString("Vous avez GAGNE avec un score de :", 60, 75);
        }
